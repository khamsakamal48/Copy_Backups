...
recipient = "dhananjay.satale@iitb.ac.in, kamal.hamsa@iitb.ac.in, amol.rathod@iitb.ac.in"
...
'''
message = sendInst.create_message('Kamal Hamza <kamal.hamsa@iitb.ac.in>', recipient, subject, emailbody)
